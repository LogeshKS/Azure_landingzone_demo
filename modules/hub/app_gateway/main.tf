locals {
  appgw_ipconfig                 = "${var.stack_name}-appgw-ipconfig"
  frontend_ip_configuration_name = "${var.stack_name}-appgw-feip"
  frontend_port_name             = "${var.stack_name}-appgw-feport"
  listener_name                  = "${var.stack_name}-appgw-lstn"
}

resource "azurerm_user_assigned_identity" "appgw" {
  resource_group_name = var.hub_rg_name
  location            = var.location
  name                = "${var.stack_name}-appgw"
}
